...
\isthesis{
    title={Toán rời rạc và thuật toán},
    sub-title={
        Framework tìm kiếm hiệu quả kết hợp meta-heuristic \\
        giải bài toán định tuyến xe (VRP) với khung thời gian
    },
    author-name={Nguyễn Mạnh Linh, Nguyễn Thị Đông, Triệu Hồng Thúy}, 
    ...
    submission-date={2022-12-25}, % The date you handed in your document: Format yyyy-mm-dd
